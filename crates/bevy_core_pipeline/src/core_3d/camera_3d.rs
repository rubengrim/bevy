use crate::{
    ...
    tonemapping::{TonemappingCurve, TonemappingMode, TonemappingSettings},
};
...
impl Default for Camera3dBundle {
    fn default() -> Self {
        Self {
            ...
            tonemapping_settings: TonemappingSettings {
                mode: TonemappingMode::Global,
                curve: TonemappingCurve::ACESFilmic,
                deband_dither: true,
            },
