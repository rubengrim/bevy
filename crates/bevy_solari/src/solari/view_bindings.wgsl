...
@group(1) @binding(2) var g_buffer_previous: texture_storage_2d<rgba16uint, read>;
...
@group(1) @binding(10) var indirect_diffuse_denoiser_temporal_history: texture_storage_2d<rgba16float, read>;
