...
@group(0) @binding(3) var<storage> triangle_counts: array<u32>;
@group(0) @binding(4) var<storage> inverse_transpose_transforms: array<mat4x4<f32>>;
...
@group(0) @binding(9) var<storage> emissive_object_mesh_material_indices: array<u32>;
@group(0) @binding(10) var<storage> emissive_object_transforms: array<mat4x4<f32>>;
