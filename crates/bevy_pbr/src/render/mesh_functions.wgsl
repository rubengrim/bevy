...
fn mesh_normal_local_to_world(vertex_normal: vec3<f32>, mesh: Mesh) -> vec3<f32> {
...
// mesh flag
fn sign_determinant_model_3x3(mesh_flags: u32) -> f32 {
...
fn mesh_tangent_local_to_world(model: mat4x4<f32>, vertex_tangent: vec4<f32>, mesh_flags: u32) -> vec4<f32> {
    ...
    return vec4<f32>(
        ...
        vertex_tangent.w * sign_determinant_model_3x3(mesh_flags)
    );
}
